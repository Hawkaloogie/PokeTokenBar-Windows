...
- Upstream changes only the displayed number: gauges, colors, notifications, warning/critical thresholds, rewards, and alert edge detection keep utilization semantics. Windows follows that rule. Compact tray/hover text uses "left" in Remaining mode.
